...
static bool isAtEnd(const Scanner* scanner) {
...
static const char peek(Scanner* scanner) { return *scanner->current; }

static const char peekNext(const Scanner* scanner) {
  if (isAtEnd(scanner))
    return '\0';
  return scanner->current[1];
}
...
static const Token string(Scanner* scanner) {
...
static const Token number(Scanner* scanner) {
...
const Token scanToken(Scanner* scanner) {
